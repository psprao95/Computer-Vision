...
# conversion from non-linear to linear RGB
...
#conversion from nonlinear RGB to sRGB
...
# converting pixels in window to xyY domain
...
# conversion back to sRGB domain
for i in range (H1,H2+1):
    for j in range (W1,W2+1):
        x,y,Y=temp[i,j]
        temp[i,j]=xyY_To_XYZ(x,y,Y)
